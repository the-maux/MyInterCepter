...
public class                    VunlsProtoAdapter extends RecyclerView.Adapter<GenericLittleCardAvatarHolder> {
    ...
    public                      VunlsProtoAdapter(VulnsScanActivity activity, Host host) {
    ...
    private void                setLogo(CircleImageView logo, int position) {
        int res;
        switch (position) {
            case 0:
