...
public class ViewReplacer {
    ...
    public ViewReplacer(View sourceView) {
        ...
        Log.d(TAG, "Id:"+mSourceView.getId());
    }
    ...
    public void replace(int targetViewResID) {
        ...
        Log.d(TAG, "Replace::(mTargetViewResID["+ mTargetViewResID+ "]: -> " + targetViewResID);
    }
    ...
    public void replace(View targetView) {
        ...
        Log.d(TAG, "Replace::(mCurrentView["+ mCurrentView.getId()+ "]: -> " + targetView.getId());
    }
