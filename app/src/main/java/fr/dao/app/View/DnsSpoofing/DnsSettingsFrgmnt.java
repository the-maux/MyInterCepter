...
public class                        DnsSettingsFrgmnt extends SettingsFrgmnt {
    ...
    public View                     onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mActivity.setToolbarTitle("Settings", "Dns spoofing");
    ...
    private void                    buildSettings() {
        ...
        addItemMenu(Title,
                ...
                "true",
                ContextCompat.getColor(mActivity, R.color.dnsSpoofSwitch),ContextCompat.getColor(mActivity, R.color.dnsSpoofSwitchBack));
        }
